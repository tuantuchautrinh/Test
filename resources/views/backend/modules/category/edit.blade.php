...
@section('content')
    ...
    <form action="{{ route('admin.category.update', ['id' => $category->id]) }}" method="POST" enctype="multipart/form-data" style="width: 650px;">
        ...
        <fieldset>
                ...
                <span class="form_item">
                    <select name="parent">
                        ...
                        @php
                            theloaicha($categories, old('parent', $category->parent));
                        @endphp
                    </select>
                </span><br />
                ...
                <span class="form_item">
                    ...
                    <input type="text" name="name" class="textbox" value="{{ old('name', $category->name) }}" />
                </span><br />
                ...
                <span class="form_item">
                    ...
                    <input type="radio" name="status" value="2" {{ (old('status', $category->status) == 2) ? 'checked' : '' }} /> Ẩn
                </span><br />
                <span class="form_label"></span>
                <span class="form_item">
                    <input type="submit" name="add" value="Sửa thể loại" class="button" />
                </span>
            </fieldset>
    </form>
@endsection
